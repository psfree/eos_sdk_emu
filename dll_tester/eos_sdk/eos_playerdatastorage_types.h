...
// next free callback_id: k_iPlayerDataStorageCallbackBase + 9
...
#include <eos_playerdatastorage_types1.8.0.h>

#define EOS_PLAYERDATASTORAGE_FILEMETADATA_API_LATEST                      EOS_PLAYERDATASTORAGE_FILEMETADATA_API_001
