...
enum { k_iTitleStorageCallbackBase = 13000 };
// next free callback_id: k_iTitleStorageCallbackBase + 6

#define EOS_TitleStorage_FileMetadata                      EOS_TitleStorage_FileMetadata001
...
#include <eos_titlestorage_types1.8.0.h>

#define EOS_TITLESTORAGE_FILEMETADATA_API_LATEST                      EOS_TITLESTORAGE_FILEMETADATA_API_001
