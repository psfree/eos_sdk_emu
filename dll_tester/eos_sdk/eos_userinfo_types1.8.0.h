...
#define EOS_USERINFO_QUERYUSERINFO_API_001 1

/**
 * Input parameters for the EOS_UserInfo_QueryUserInfo function.
 */
EOS_STRUCT(EOS_UserInfo_QueryUserInfoOptions001, (
...
EOS_STRUCT(EOS_UserInfo_QueryUserInfoCallbackInfo, (
	enum { k_iCallback = k_iUserInfoCallbackBase + 0 };
...
#define EOS_USERINFO_QUERYUSERINFOBYDISPLAYNAME_API_001 1

/**
 * Input parameters for the EOS_UserInfo_QueryUserInfoByDisplayName function.
 */
EOS_STRUCT(EOS_UserInfo_QueryUserInfoByDisplayNameOptions001, (
...
#define EOS_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNT_API_001 1

/**
 * Input parameters for the EOS_UserInfo_QueryUserInfoByExternalAccount function.
 */
EOS_STRUCT(EOS_UserInfo_QueryUserInfoByExternalAccountOptions001, (
