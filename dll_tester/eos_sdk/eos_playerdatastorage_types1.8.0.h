...
#define EOS_PLAYERDATASTORAGE_QUERYFILEOPTIONS_API_001 1

/**
 * Input data for the EOS_PlayerDataStorage_QueryFile function
 */
EOS_STRUCT(EOS_PlayerDataStorage_QueryFileOptions001, (
...
EOS_STRUCT(EOS_PlayerDataStorage_QueryFileCallbackInfo, (
	enum { k_iCallback = k_iPlayerDataStorageCallbackBase + 0 };
...
#define EOS_PLAYERDATASTORAGE_QUERYFILELISTOPTIONS_API_001 1

/**
 * Input data for the EOS_PlayerDataStorage_QueryFileList function
 */
EOS_STRUCT(EOS_PlayerDataStorage_QueryFileListOptions001, (
...
#define EOS_PLAYERDATASTORAGE_GETFILEMETADATACOUNTOPTIONS_API_001 1

/**
 * Input data for the EOS_PlayerDataStorage_GetFileMetadataCount function
 */
EOS_STRUCT(EOS_PlayerDataStorage_GetFileMetadataCountOptions001, (
...
#define EOS_PLAYERDATASTORAGE_COPYFILEMETADATAATINDEXOPTIONS_API_001 1

/**
 * Input data for the CopyFileMetadataAtIndex function
 */
EOS_STRUCT(EOS_PlayerDataStorage_CopyFileMetadataAtIndexOptions001, (
...
#define EOS_PLAYERDATASTORAGE_COPYFILEMETADATABYFILENAMEOPTIONS_API_001 1

/**
 * Input data for the CopyFileMetadataByFilename function
 */
EOS_STRUCT(EOS_PlayerDataStorage_CopyFileMetadataByFilenameOptions001, (
...
#define EOS_PLAYERDATASTORAGE_DUPLICATEFILEOPTIONS_API_001 1

/**
 * Input data for the EOS_PlayerDataStorage_DuplicateFile function
 */
EOS_STRUCT(EOS_PlayerDataStorage_DuplicateFileOptions001, (
...
#define EOS_PLAYERDATASTORAGE_DELETEFILEOPTIONS_API_001 1

/**
 * Input data for the EOS_PlayerDataStorage_DeleteFile function
 */
EOS_STRUCT(EOS_PlayerDataStorage_DeleteFileOptions001, (
...
#define EOS_PLAYERDATASTORAGE_READFILEOPTIONS_API_001 1

/**
 * Input data for the EOS_PlayerDataStorage_ReadFile function
 */
EOS_STRUCT(EOS_PlayerDataStorage_ReadFileOptions001, (
...
#define EOS_PLAYERDATASTORAGE_WRITEFILEOPTIONS_API_001 1

/**
 * Input data for the EOS_PlayerDataStorage_WriteFile function
 */
EOS_STRUCT(EOS_PlayerDataStorage_WriteFileOptions001, (
