...
#define EOS_AUTH_CREDENTIALS_API_003 3
 ...
 */
EOS_STRUCT(EOS_Auth_Credentials003, (
...
#define EOS_AUTH_ACCOUNTFEATURERESTRICTEDINFO_API_001 1
 ...
 */
EOS_STRUCT(EOS_Auth_AccountFeatureRestrictedInfo001, (
...
EOS_STRUCT(EOS_Auth_LoginCallbackInfo, (
	enum { k_iCallback = k_iAuthCallbackBase + 0 };
...
#define EOS_AUTH_LINKACCOUNT_API_001 1

/**
 * Input parameters for the EOS_Auth_LinkAccount function.
 */
EOS_STRUCT(EOS_Auth_LinkAccountOptions001, (
...
#define EOS_AUTH_DELETEPERSISTENTAUTH_API_002 2

/**
 * Input parameters for the EOS_Auth_DeletePersistentAuth function.
 */
EOS_STRUCT(EOS_Auth_DeletePersistentAuthOptions002, (
