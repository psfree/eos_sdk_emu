...
#define EOS_LOBBYDETAILS_INFO_API_003 3

EOS_STRUCT(EOS_LobbyDetails_Info003, (
...
#define EOS_LOBBY_CREATELOBBY_API_009 9

/**
 * Input parameters for the EOS_Lobby_CreateLobby function.
 */
EOS_STRUCT(EOS_Lobby_CreateLobbyOptions009, (
...
#define EOS_LOBBY_JOINLOBBY_API_004 4

/**
 * Input parameters for the EOS_Lobby_JoinLobby function.
 */
EOS_STRUCT(EOS_Lobby_JoinLobbyOptions004, (
...
EOS_STRUCT(EOS_Lobby_JoinLobbyCallbackInfo, (
	enum { k_iCallback = k_iLobbyCallbackBase + 20 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
...
#define EOS_LOBBY_JOINLOBBYBYID_API_002 2

/**
 * Input parameters for the EOS_Lobby_JoinLobbyById function.
 */
EOS_STRUCT(EOS_Lobby_JoinLobbyByIdOptions002, (
...
EOS_STRUCT(EOS_Lobby_PromoteMemberCallbackInfo, (
	enum { k_iCallback = k_iLobbyCallbackBase + 18 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
...
EOS_STRUCT(EOS_Lobby_KickMemberCallbackInfo, (
	enum { k_iCallback = k_iLobbyCallbackBase + 19 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
...
#define EOS_LOBBY_HARDMUTEMEMBER_API_001 1

/**
 * Input parameters for the EOS_Lobby_HardMuteMember function.
 */
EOS_STRUCT(EOS_Lobby_HardMuteMemberOptions001, (
...
#define EOS_LOBBY_ADDNOTIFYLOBBYINVITEREJECTED_API_001 1

EOS_STRUCT(EOS_Lobby_AddNotifyLobbyInviteRejectedOptions001, (
...
#define EOS_LOBBY_ADDNOTIFYSENDLOBBYNATIVEINVITEREQUESTED_API_001 1

EOS_STRUCT(EOS_Lobby_AddNotifySendLobbyNativeInviteRequestedOptions001, (
...
#define EOS_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGED_API_002 2

/**
 * Input parameters for the EOS_Lobby_AddNotifyRTCRoomConnectionChanged function.
 */
EOS_STRUCT(EOS_Lobby_AddNotifyRTCRoomConnectionChangedOptions002, (
...
#define EOS_LOBBY_GETCONNECTSTRING_API_001 1
 ...
 */
EOS_STRUCT(EOS_Lobby_GetConnectStringOptions001, (
...
#define EOS_LOBBY_PARSECONNECTSTRING_API_001 1
 ...
 * Input parameters for the EOS_Lobby_GetConnectString function.
 */
EOS_STRUCT(EOS_Lobby_ParseConnectStringOptions001, (
...
#define EOS_LOBBYMODIFICATION_ADDATTRIBUTE_API_002 2

/**
 * Input parameters for the EOS_LobbyModification_AddAttribute function.
 */
EOS_STRUCT(EOS_LobbyModification_AddAttributeOptions002, (
...
#define EOS_LOBBYMODIFICATION_ADDMEMBERATTRIBUTE_API_002 2

/**
 * Input parameters for the EOS_LobbyModification_AddMemberAttribute function.
 */
EOS_STRUCT(EOS_LobbyModification_AddMemberAttributeOptions002, (
...
#define EOS_LOBBYMODIFICATION_SETALLOWEDPLATFORMIDS_API_001 1

/**
 * Input parameters for the EOS_LobbyModification_SetAllowedPlatformIdsOptions function.
 */
EOS_STRUCT(EOS_LobbyModification_SetAllowedPlatformIdsOptions001, (
...
#define EOS_LOBBYDETAILS_COPYMEMBERINFO_API_001 1

/**
 * Input parameters for the EOS_LobbyDetails_CopyMemberInfo function.
 */
EOS_STRUCT(EOS_LobbyDetails_CopyMemberInfoOptions001, (
...
#define EOS_LOBBYDETAILS_MEMBERINFO_API_001 1

EOS_STRUCT(EOS_LobbyDetails_MemberInfo001, (
...
EOS_DECLARE_FUNC(void) EOS_LobbyDetails_MemberInfo_Release(EOS_LobbyDetails_MemberInfo001* LobbyDetailsMemberInfo);

/** The most recent version of the EOS_Lobby_AddNotifyLeaveLobbyRequested API. */
#define EOS_LOBBY_ADDNOTIFYLEAVELOBBYREQUESTED_API_001 1

EOS_STRUCT(EOS_Lobby_AddNotifyLeaveLobbyRequestedOptions001, (
