...
#define EOS_TITLESTORAGE_QUERYFILEOPTIONS_API_001 1

/**
 * Input data for the EOS_TitleStorage_QueryFile function
 */
EOS_STRUCT(EOS_TitleStorage_QueryFileOptions001, (
...
EOS_STRUCT(EOS_TitleStorage_QueryFileCallbackInfo, (
	enum { k_iCallback = k_iTitleStorageCallbackBase + 0 };
...
#define EOS_TITLESTORAGE_QUERYFILELISTOPTIONS_API_001 1

/**
 * Input data for the EOS_TitleStorage_QueryFileList function
 */
EOS_STRUCT(EOS_TitleStorage_QueryFileListOptions001, (
...
EOS_STRUCT(EOS_TitleStorage_QueryFileListCallbackInfo, (
	enum { k_iCallback = k_iTitleStorageCallbackBase + 1 };
	/** Result code for the operation. EOS_Success is returned for a successful request, other codes indicate an error */
	EOS_EResult ResultCode;
	/** Client-specified data passed into the file query request */
	void* ClientData;
...
#define EOS_TITLESTORAGE_GETFILEMETADATACOUNTOPTIONS_API_001 1

/**
 * Input data for the EOS_TitleStorage_GetFileMetadataCount function
 */
EOS_STRUCT(EOS_TitleStorage_GetFileMetadataCountOptions001, (
...
#define EOS_TITLESTORAGE_COPYFILEMETADATAATINDEXOPTIONS_API_001 1

/**
 * Input data for the CopyFileMetadataAtIndex function
 */
EOS_STRUCT(EOS_TitleStorage_CopyFileMetadataAtIndexOptions001, (
...
#define EOS_TITLESTORAGE_COPYFILEMETADATABYFILENAMEOPTIONS_API_001 1

/**
 * Input data for the CopyFileMetadataByFilename function
 */
EOS_STRUCT(EOS_TitleStorage_CopyFileMetadataByFilenameOptions001, (
...
EOS_STRUCT(EOS_TitleStorage_FileTransferProgressCallbackInfo, (
	enum { k_iCallback = k_iTitleStorageCallbackBase + 2 };
...
EOS_STRUCT(EOS_TitleStorage_ReadFileDataCallbackInfo, (
	enum { k_iCallback = k_iTitleStorageCallbackBase + 3 };
	/** Client-specified data passed into the file request */
	void* ClientData;
	/** Product User ID of the local user who initiated this request (optional, will only be present in case it was provided during operation start) */
	EOS_ProductUserId LocalUserId;
...
#define EOS_TITLESTORAGE_READFILEOPTIONS_API_001 1

/**
 * Input data for the EOS_TitleStorage_ReadFile function
 */
EOS_STRUCT(EOS_TitleStorage_ReadFileOptions001, (
...
EOS_STRUCT(EOS_TitleStorage_ReadFileCallbackInfo, (
	enum { k_iCallback = k_iTitleStorageCallbackBase + 4 };
	/** Result code for the operation. EOS_Success is returned for a successful request, other codes indicate an error */
	EOS_EResult ResultCode;
...
#define EOS_TITLESTORAGE_DELETECACHEOPTIONS_API_001 1

/**
 * Input data for the EOS_TitleStorage_DeleteCache function
 */
EOS_STRUCT(EOS_TitleStorage_DeleteCacheOptions001, (
...
EOS_STRUCT(EOS_TitleStorage_DeleteCacheCallbackInfo, (
	enum { k_iCallback = k_iTitleStorageCallbackBase + 5 };
	/** Result code for the operation. EOS_Success is returned for a successful request, other codes indicate an error */
	EOS_EResult ResultCode;
