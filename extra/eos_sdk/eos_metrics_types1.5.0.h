...
#define EOS_METRICS_BEGINPLAYERSESSION_API_001 1

/** BeginPlayerSession. */
EOS_STRUCT(EOS_Metrics_BeginPlayerSessionOptions001, (
	/** API Version */
	int32_t ApiVersion;
...
#define EOS_METRICS_ENDPLAYERSESSION_API_001 1

/** EndPlayerSession. */
EOS_STRUCT(EOS_Metrics_EndPlayerSessionOptions001, (
	/** API Version */
	int32_t ApiVersion;
	/** Account ID type that is set in the union. */
	EOS_EMetricsAccountIdType AccountIdType;
