...
EOS_STRUCT(EOS_Connect_LoginCallbackInfo, (
	enum { k_iCallback = k_iConnectCallbackBase + 0 };
...
#define EOS_CONNECT_UNLINKACCOUNT_API_001 1

/**
 * Input parameters for the EOS_Connect_UnlinkAccount Function.
 */
EOS_STRUCT(EOS_Connect_UnlinkAccountOptions001, (
...
#define EOS_CONNECT_TRANSFERDEVICEIDACCOUNT_API_001 1

/**
 * Input parameters for the EOS_Connect_TransferDeviceIdAccount Function.
 */
EOS_STRUCT(EOS_Connect_TransferDeviceIdAccountOptions001, (
...
#define EOS_CONNECT_GETEXTERNALACCOUNTMAPPING_API_001 1

/** DEPRECATED! Use EOS_CONNECT_GETEXTERNALACCOUNTMAPPING_API_LATEST instead. */
#define EOS_CONNECT_GETEXTERNALACCOUNTMAPPINGS_API_LATEST EOS_CONNECT_GETEXTERNALACCOUNTMAPPING_API_001
...
#define EOS_CONNECT_QUERYPRODUCTUSERIDMAPPINGS_API_002 2
 ...
 */
EOS_STRUCT(EOS_Connect_QueryProductUserIdMappingsOptions002, (
...
EOS_STRUCT(EOS_Connect_LoginStatusChangedCallbackInfo, (
	enum { k_iCallback = k_iConnectCallbackBase + 10 };
